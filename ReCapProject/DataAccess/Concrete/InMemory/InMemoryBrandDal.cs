...
{
    //ıbranddalın bütün herşeyini implament et demek için 
    public class InMemoryBrandDal : IBrandDal
    {

        List<Brand> _brands;
        //global değişken
        public InMemoryBrandDal()//constructr void döndürmüyor.
        {
            _brands = new List<Brand>
            {
                //oraclı sql,mongodbden geliyomuş gibi simule ediyoruz
